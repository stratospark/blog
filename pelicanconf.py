...
# Blogroll
LINKS = (('#1: Generating Synthetic Data for Image Segmentation with Unity ', '/generating-synthetic-data-image-segmentation-unity-pytorch-fastai.html'),
         ('#2: Training Food Classifier with Keras/Tensorflow', '/deep-learning-applied-food-classification-deep-learning-keras.html'),
